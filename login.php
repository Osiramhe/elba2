...
if(isset($_SESSION['user_id'])) { 
    header("Location:account.php?Already logged in");// send to login page
    exit;
}
					...
					<div class="p-r-15 p-rl-0-lg" style="width:70%;margin:0 auto">
						...
						<form class="how-bor3 p-rl-30 p-tb-32" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
							<div class="p-b-24">
								...
								<input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 focus1" required type="email" name="email" placeholder="Your Email *">
